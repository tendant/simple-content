...
// PresignedUploadClient demonstrates how to implement a Go client for presigned uploads
type PresignedUploadClient struct {
	baseURL    string
	httpClient *http.Client
}

// NewPresignedUploadClient creates a new client for presigned uploads
func NewPresignedUploadClient(baseURL string) *PresignedUploadClient {
...
// UploadFile performs the complete presigned upload workflow
func (c *PresignedUploadClient) UploadFile(ctx context.Context, req UploadRequest) (*PrepareResponse, error) {
	...
	// Step 3: Perform presigned upload to storage
	fmt.Println("Uploading file directly to storage...")
	err = c.performPresignedUpload(ctx, file, prepareResp)
	if err != nil {
		return nil, fmt.Errorf("presigned upload failed: %w", err)
	}

	fmt.Println("Presigned upload completed")
...
func (c *PresignedUploadClient) prepareUpload(ctx context.Context, req UploadRequest, fileInfo os.FileInfo) (*PrepareResponse, error) {
...
// performPresignedUpload uploads the file directly to the storage backend
func (c *PresignedUploadClient) performPresignedUpload(ctx context.Context, file *os.File, prepareResp *PrepareResponse) error {
...
func (c *PresignedUploadClient) confirmUpload(ctx context.Context, objectID string) error {
...
func (c *PresignedUploadClient) GetUploadStatus(ctx context.Context, objectID string) (map[string]interface{}, error) {
...
func (c *PresignedUploadClient) ListContent(ctx context.Context, ownerID, tenantID string) ([]map[string]interface{}, error) {
...
func (c *PresignedUploadClient) makeJSONRequest(ctx context.Context, method, endpoint string, body interface{}, response interface{}) error {
...
func exampleUsage() {
	// Create client
	client := NewPresignedUploadClient("http://localhost:8080")
	...
	uploadReq := UploadRequest{
		...
		Tags:        []string{"demo", "go-client", "presigned-upload"},
	}
